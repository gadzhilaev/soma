...
abstract class AppLocalizations {
  ...
  /// No description provided for @supportFormMessageHint.
  ///
  /// In en, this message translates to:
  /// **'Type your request'**
  String get supportFormMessageHint;

  /// No description provided for @supportFormContactsLabel.
  ///
  /// In en, this message translates to:
  /// **'Your other contacts (optional)'**
  String get supportFormContactsLabel;

  /// No description provided for @supportFormContactsHint.
  ///
  /// In en, this message translates to:
  /// **'Telegram: @nullscode'**
  ...
  /// No description provided for @supportFormErrorTitle.
  ///
  /// In en, this message translates to:
  /// **'Attention!'**
  String get supportFormErrorTitle;

  /// No description provided for @supportFormErrorBody.
  ///
  /// In en, this message translates to:
  /// **'The message cannot be empty or contain fewer than 12 characters.'**
  String get supportFormErrorBody;

  /// No description provided for @supportFormErrorOk.
  ///
  /// In en, this message translates to:
  /// **'OK'**
  String get supportFormErrorOk;

  /// No description provided for @supportFormSuccessTitle.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @supportFormSuccessOk.
  ///
  /// In en, this message translates to:
  /// **'OK'**
